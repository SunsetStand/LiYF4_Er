...
$PYEXEC -c "import pyscf; from embed_sim import myavas, rdiis, siso; from src.AIMP3_DMET_SCEI import AIMP_CAHF; print('Modules OK')" || { echo 'FATAL'; exit 1; }

touch JobProcessing.state
echo "Job Running at $(date)" >> JobProcessing.state

$PYEXEC -u main_AIMP_CAHF_CASCI_SCEI.py
