...
echo "opt_cluster_2 DMET ErF8 (25-atom big cluster)"
...
echo "opt2 DMET ErF8 Running at $(date)" >> JobProcessing.state

$PYEXEC -u main_AIMP_ROHF_DMET.py -i ./

echo "opt2 DMET ErF8 Finished at $(date)" >> $HOME/finish
echo "opt2 DMET ErF8 Finished at $(date)" >> JobProcessing.state
