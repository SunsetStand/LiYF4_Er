...
echo "DMET ErF8 Running at $(date)" >> JobProcessing.state

$PYEXEC -u main_AIMP_ROHF_DMET.py -i ./

echo "DMET ErF8 Finished at $(date)" >> $HOME/finish
echo "DMET ErF8 Finished at $(date)" >> JobProcessing.state
