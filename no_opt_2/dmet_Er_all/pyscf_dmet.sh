...
echo "DMET Er_all Running at $(date)" >> JobProcessing.state

$PYEXEC -u main_AIMP_ROHF_DMET.py -i ./

echo "DMET Er_all Finished at $(date)" >> $HOME/finish
echo "DMET Er_all Finished at $(date)" >> JobProcessing.state
